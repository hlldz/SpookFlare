...
from lib import sfmpps
from lib import sfhta
from lib import sfvba
 ...
 is to compile and run the first part at runtime.'''
    ...
    def do_set(self, line):
        ...
        if line.split()[0] == "PROTO":
            ...
            if line.split()[1] == "x86" or line.split()[1] == "x64":
    ...
    def do_generate(self, line):
        if (mpbProto == None or mpbLhost == None or mpbLport == None or mpbArch == None):
...
class jsHtaModule(sfCmd):
 ...
 the target system.'''
    ...
    def do_generate(self, line):
        if (htaDownloadName == None or htaCmdFile == None):
            print "\n \033[1m\033[91m[!]\033[0m Please check your values.\n"
        else:
 ...
 system commands can be executed on the target system.'''
    ...
    def do_set(self, line):
        ...
        if line.split()[0] == "FTYPE":
            if line.split()[1] == "word" or line.split()[1] == "excel" or line.split()[1] == "powerpoint":
                vbaFileType = line.split()[1]
                print "FTYPE => " + line.split()[1]
            else:
                print "\n \033[1m\033[91m[!]\033[0m Please enter valid value.\n"
        if line.split()[0] == "META":
            if line.split()[1] == "Comments" or line.split()[1] == "Company":
    ...
    def do_generate(self, line):
        if (vbaCmdFile == None or vbaFileType == None or vbaMetaName == None):
            print "\n \033[1m\033[91m[!]\033[0m Please check your values.\n"
        else:
            print "\n \033[1m\033[94m[*]\033[0m Generating payload...\033[0m"
